...
vim.opt.showcmd = false -- Hide command characters (like /) from showing
...
require('lazy').setup({
  ...
  -- LSP Plugins
  {
    ...
    config = function()
      ...
      --    That is to say, every time a new file is opened that is associated withmason
      ...
      if ok then capabilities = vim.tbl_deep_extend('force', capabilities, blink_cmp.get_lsp_capabilities()) end
  ...
  --
  --           -- Keymaps for snippet navigation (similar to your old config)
  --           keymap = {
  --             preset = 'default',

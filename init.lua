...
do
  ...
  vim.keymap.set('n', '<C-b>', '<cmd>Neotree toggle<CR>', { desc = 'Toggle file browser' })
...
do
  ...
  require('conform').setup {
    ...
    format_on_save = function(bufnr)
      -- Disable format-on-save for languages without one standard style.
...
do
  ...
  local parsers = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'javascript', 'typescript', 'tsx', 'jsx', 'json', 'css', 'scss', 'python', 'go', 'sql', 'regex' }
